  ...
  useEffect(() => {
    ...
    async function loadInitialTickets() {
      ...
      try {
        ...
        if (current) { setTickets(result); setProduction(currentProduction); setMembers(team); const ownMembership = team.find((member) => member.uid === user.uid); if (ownMembership?.department) setDepartmentFilter(ownMembership.department); }
