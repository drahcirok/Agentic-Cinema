  ...
  useEffect(() => {
    ...
    async function loadInitialTickets() {
      ...
      try {
        ...
        if (current) { setTickets(result); setProduction(currentProduction); setMembers(team); }
